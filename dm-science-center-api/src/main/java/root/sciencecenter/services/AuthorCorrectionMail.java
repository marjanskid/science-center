...
@Service
public class AuthorCorrectionMail implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        System.out.println("------------------------------------------");
        System.out.println("AuthorCorrectionMail");
        ...
        if (foundProcessUser != null) {
            ...
            String emailText = String.format("New article that has been posted form author '%s'" +
                    " has to be corrected, please check your tasks.", processUser);
